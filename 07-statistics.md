...
**This would be the probability that Elvis is an identical twin AND a twin brother, divided by the the probability that he is a twin brother (fraternal or identical). So the numerator would be 1/2 * 1/300, and the denominator would be 1/2 * 1/300 + 1/4 * 1/125. Which can be reduced to 5/11.
